...
public class TesteWrapper {
	...
	public static void main(String[] args) {
		...
		System.out.println("10 é igual a 10 ? 0 para Sim ! " + Integer.compare(10, 10));
		System.out.println("11 é igual a 10 ? 0 para Sim ! " + Integer.compare(11, 10));		
		System.out.println("12 é igual a 10 ? 0 para Sim ! " + Integer.compare(12, 10));		
		System.out.println("12 é igual a 12 ? 0 para Sim ! " + Integer.compare(12, 12));
		System.out.println("10 mais 12 ? 22 = " + Integer.sum(10, 12));
		System.out.println("Qual é o maior ? 10 ou 12 ? = " + Integer.max(10, 12));		
		System.out.println("Qual é o menor ? 10 ou 12 ? = " + Integer.min(10, 12));		
		System.out.println("==================");
		...
		System.out.println("char c1 = é Letra ? = " + Character.isLetter(c1.charValue()));
		System.out.println("char c1 = é Letra ou Dígito ? = " + Character.isLetterOrDigit(c1.charValue()));
		System.out.println("char c1 = é Minúscula ? = " + Character.isLowerCase(c1.charValue()));		
		System.out.println("char c1 = é Maiúscula ? = " + Character.isUpperCase(c1.charValue()));		
		c1 = new Character('a');
		System.out.println("char c1 = a para Maiúscula ? = " + Character.toUpperCase(c1.charValue()));
		c1 = new Character('A');
		System.out.println("char c1 = a para Minúscula ? = " + Character.toLowerCase(c1.charValue()));
		System.out.println("==================");
		...
		System.out.println("Comparando TESTE a TESTE: 0 para True " + varTESTE.compareTo("TESTE"));
		...
		varTESTE = new String("      Retira o Espaço em branco        ");
		System.out.println(varTESTE);
		System.out.println("Retira espaço em Branco: " + varTESTE.trim());		
